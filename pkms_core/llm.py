...
class LLMAdapter:
    ...
    This adapter intentionally returns None for summarize() when no key is present. The demo script
    will fall back to a MockLLM implementation that always provides a demo response.
    """
    def __init__(self):
